...
namespace Com.Latipium.Defaults.Graphics {
	internal class GameRenderer {
        ...
        private Func<Com.Latipium.Core.Tuple<float, float, float>, Com.Latipium.Core.Tuple<float, float, float>> PlayerPosition;
		...
		internal LatipiumObject Player {
			...
			set {
				if ( value != null ) {
					_Player = value;
                    PlayerPosition = _Player.GetFunction<Com.Latipium.Core.Tuple<float, float, float>, Com.Latipium.Core.Tuple<float, float, float>>("Position");
